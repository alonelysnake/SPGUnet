...
class SPGUNetPredictor(nnUNetPredictor):
    def __init__(self,
    ...
    def initialize_from_trained_model_folder(self, model_training_output_dir: str,
        ...
        assert isinstance(network,SPGUNet)
        network.set_stage(1)
...
def parse_args():
    ...
    parser.add_argument('-tr', type=str, required=False, default='SPGUNetTrainer',
                        help='What nnU-Net trainer class was used for training?')
...
def predict(args):
    ...
    model_folder = get_output_folder(args.d, args.tr, args.p, '3d_fullres')
    if not isdir(args.o):
    ...
    predictor = SPGUNetPredictor(tile_step_size=args.step_size,
                                 use_gaussian=True,
